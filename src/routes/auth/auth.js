...
export default class Auth {
  ...
  async routes() {
    ...
    this.router
      ...
      .put(schemaValidator(forgotPasswordValidator), (req, res) => this.authInstance.forgotPassword(req, res));

    /*** reset password ***/
    this.router
      .route('/auth/reset-password/:token')
      .put(schemaValidator(resetPasswordValidator), (req, res) => this.authInstance.resetPassword(req, res));
  }
}
